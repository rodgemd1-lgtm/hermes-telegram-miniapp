...
React SPA dashboard for Telegram Mini App v2.0 - 10-page mobile-first UI. Runs locally. Evidence from the tracked tree: Documentation corpus.

## Live State

| Field | Value |
| --- | --- |
| GitHub | https://github.com/rodgemd1-lgtm/hermes-telegram-miniapp |
| QNAP canonical/mirror | `ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/hermes-telegram-miniapp.git` |
| Lane | `rig-core` - RIG/Jake/Hermes/Deviator operating system |
| Visibility | `public` |
| Primary language | `TypeScript` |
| Last pushed | `2026-04-17T17:41:13Z` |
| QNAP status | `imported_to_qnap_gitea` |
| QNAP HEAD | `d524031d6dea` |
| Consolidation action | `keep-separate-public` |
| Canonical target | `hermes-telegram-miniapp` |
...
- Repo deep dive: [hermes-telegram-miniapp](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-deep-dives/hermes-telegram-miniapp.md)
...
10 data/config/knowledge-like files; 4 docs/notes; 1 media/design assets; 1 sensitive-path-name matches.
...
68 tracked files across 15 directories. Code files: 42. Test files: 0. 10 data/config/knowledge-like files; 4 docs/notes; 1 media/design assets; 1 sensitive-path-name matches.

Aggregate GitHub tree size: `1.1 MB` across `68` blobs.
...
Full public inventory: [hermes-telegram-miniapp.txt](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-file-inventories/hermes-telegram-miniapp.txt)
